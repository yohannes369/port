...
//       >
//         {/* Removed FaBars/FaTimes icons, replaced with text */}
//         {nav ? "Close" : "Menu"}
//       </motion.div>
...
//                   className={`text-2xl px-6 py-3 text-gray-300 hover:text-white transition-colors cursor-pointer font-medium relative group ${
//                     activeLink === to ? "text-white" : ""
//                   }`}
//                 >
//                   {name}
